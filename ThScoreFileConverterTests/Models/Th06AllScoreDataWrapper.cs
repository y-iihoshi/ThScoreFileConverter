...
namespace ThScoreFileConverterTests.Models
{
    ...
    internal sealed class Th06AllScoreDataWrapper
    {
        ...
        public object Ranking(Th06CharaLevelPairWrapper pair)
            => this.Rankings.GetType().GetProperty("Item").GetValue(this.Rankings, new object[] { pair.Target });
        public Th06HighScoreWrapper RankingItem(Th06CharaLevelPairWrapper pair, int index)
        {
        ...
        public object PracticeScoresPerCharaLevelPair(Th06CharaLevelPairWrapper pair)
            => this.PracticeScores.GetType().GetProperty("Item").GetValue(
                this.PracticeScores, new object[] { pair.Target });
        public Th06PracticeScoreWrapper PracticeScore(Th06CharaLevelPairWrapper pair, ThConverter.Stage stage)
        {
