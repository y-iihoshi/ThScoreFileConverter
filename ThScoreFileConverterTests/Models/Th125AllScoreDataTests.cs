...
namespace ThScoreFileConverterTests.Models
{
    ...
    public class Th125AllScoreDataTests
    {
        ...
        {
            var array = Th095HeaderTests.MakeByteArray(Th095HeaderTests.GetValidProperties("T125"));
            var header = Th095HeaderWrapper<Th125Converter>.Create(array);
        ...
        {
            var array = Th095HeaderTests.MakeByteArray(Th095HeaderTests.GetValidProperties("T125"));
            var header1 = Th095HeaderWrapper<Th125Converter>.Create(array);
            var header2 = Th095HeaderWrapper<Th125Converter>.Create(array);
        ...
        public void Th125AllScoreDataSetClearDataTest() => TestUtils.Wrap(() =>
        {
            ...
            var chapter = Th095ChapterWrapper<Th125Converter>.Create(Th125ScoreTests.MakeByteArray(properties));
