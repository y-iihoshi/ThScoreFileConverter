...
#region Th13
        ...
        public void Th13ClearDataTestChapter()
            => ClearDataTestChapterHelper<
                Th13Converter, Th13Converter.CharaWithTotal, Th13Converter.StageProgress>(1, 0x56DC, 127);

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Th13ClearDataTestNullChapter()
            => ClearDataTestNullChapterHelper<
                Th13Converter, Th13Converter.CharaWithTotal, Th13Converter.StageProgress>();
...
#region Th14
        ...
        public void Th14ClearDataTestChapter()
            => ClearDataTestChapterHelper<
                Th14Converter, Th14Converter.CharaWithTotal, Th14Converter.StageProgress>(1, 0x5298, 120);

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Th14ClearDataTestNullChapter()
            => ClearDataTestNullChapterHelper<
                Th14Converter, Th14Converter.CharaWithTotal, Th14Converter.StageProgress>();
...
#region Th15
        ...
        [TestMethod]
        public void Th15ClearDataTestChapter()
            => ClearDataTestChapterHelper<
                Th15Converter, Th15Converter.CharaWithTotal, Th15Converter.StageProgress>(1, 0xA4A0, 119);

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Th15ClearDataTestNullChapter()
            => ClearDataTestNullChapterHelper<
                Th15Converter, Th15Converter.CharaWithTotal, Th15Converter.StageProgress>();

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th15ClearDataTestInvalidSignature()
            => ClearDataTestInvalidSignatureHelper<
                Th15Converter, Th15Converter.CharaWithTotal, Th15Converter.StageProgress>(1, 0xA4A0, 119);

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th15ClearDataTestInvalidVersion()
            => ClearDataTestInvalidVersionHelper<
                Th15Converter, Th15Converter.CharaWithTotal, Th15Converter.StageProgress>(1, 0xA4A0, 119);

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th15ClearDataTestInvalidSize()
            => ClearDataTestInvalidSizeHelper<
                Th15Converter, Th15Converter.CharaWithTotal, Th15Converter.StageProgress>(1, 0xA4A0, 119);
...
#region Th16
        ...
        [TestMethod]
        public void Th16ClearDataTestChapter()
            => ClearDataTestChapterHelper<
                Th16Converter, Th16Converter.CharaWithTotal, Th16Converter.StageProgress>(1, 0x5318, 119);

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Th16ClearDataTestNullChapter()
            => ClearDataTestNullChapterHelper<
                Th16Converter, Th16Converter.CharaWithTotal, Th16Converter.StageProgress>();

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th16ClearDataTestInvalidSignature()
            => ClearDataTestInvalidSignatureHelper<
                Th16Converter, Th16Converter.CharaWithTotal, Th16Converter.StageProgress>(1, 0x5318, 119);

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th16ClearDataTestInvalidVersion()
            => ClearDataTestInvalidVersionHelper<
                Th16Converter, Th16Converter.CharaWithTotal, Th16Converter.StageProgress>(1, 0x5318, 119);

        [TestMethod]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th16ClearDataTestInvalidSize()
            => ClearDataTestInvalidSizeHelper<
                Th16Converter, Th16Converter.CharaWithTotal, Th16Converter.StageProgress>(1, 0x5318, 119);
