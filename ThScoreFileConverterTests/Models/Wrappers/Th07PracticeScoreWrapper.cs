...
namespace ThScoreFileConverterTests.Models.Wrappers
{
    ...
    internal sealed class Th07PracticeScoreWrapper
    {
        ...
        public Th07PracticeScoreWrapper(ChapterWrapper chapter)
            => this.pobj = new PrivateObject(AssemblyNameToTest, TypeNameToTest, new object[] { chapter?.Target });
        public Th07PracticeScoreWrapper(object original)
        ...
        public Th07Converter.Stage? Stage
            => this.pobj.GetProperty(nameof(this.Stage)) as Th07Converter.Stage?;
    }
}
