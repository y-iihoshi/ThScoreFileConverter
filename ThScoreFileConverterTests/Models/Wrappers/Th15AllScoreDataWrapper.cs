...
namespace ThScoreFileConverterTests.Models.Wrappers
{
    ...
    internal sealed class Th15AllScoreDataWrapper
    {
        ...
        public HeaderWrapper<Th15Converter> Header
        {
            get
            {
                var header = this.pobj.GetProperty(nameof(Header));
                return (header != null) ? new HeaderWrapper<Th15Converter>(header) : null;
            }
        }
        ...
        public void Set(HeaderWrapper<Th15Converter> header)
