...
namespace ThScoreFileConverterTests.Models
{
    ...
    public class Th08HighScoreTests
    {
        ...
        public void Th08HighScoreTestInvalidChara() => TestUtils.Wrap(() =>
        {
            var signature = "HSCR";
            short size1 = 0x0168;
            short size2 = 0x0168;
        ...
        [TestMethod()]
        [ExpectedException(typeof(InvalidCastException))]
        public void Th08HighScoreTestInvalidLevel() => TestUtils.Wrap(() =>
        {
            var signature = "HSCR";
            short size1 = 0x0168;
            short size2 = 0x0168;
        ...
        [TestMethod()]
        [ExpectedException(typeof(InvalidCastException))]
        public void Th08HighScoreTestInvalidStageProgress() => TestUtils.Wrap(() =>
        {
            var signature = "HSCR";
            short size1 = 0x0168;
            short size2 = 0x0168;
