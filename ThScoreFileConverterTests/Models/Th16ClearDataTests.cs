...
namespace ThScoreFileConverterTests.Models
{
    ...
    public class Th16ClearDataTests
    {
        internal struct Properties
        {
            ...
            public Dictionary<
                Th10LevelStagePairTests.Properties<ThConverter.Level, Th16Converter.StagePractice>,
        ...
        internal static Properties GetValidProperties()
        {
            ...
            return new Properties()
            {
                ...
                practices = levels
                    ...
                    .ToDictionary(
                        pair => new Th10LevelStagePairTests.Properties<ThConverter.Level, Th16Converter.StagePractice>()
                        {
                            level = pair.level,
                            stage = pair.stage
                        },
        ...
        internal static void Validate(in Th16ClearDataWrapper clearData, in Properties properties)
        {
            ...
            {
                var levelStagePair =
                    new Th10LevelStagePairWrapper<Th16Converter, ThConverter.Level, Th16Converter.StagePractice>(
