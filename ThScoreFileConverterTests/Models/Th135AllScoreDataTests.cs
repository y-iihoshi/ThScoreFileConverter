...
namespace ThScoreFileConverterTests.Models
{
    ...
    public class Th135AllScoreDataTests
    {
        ...
        {
            Th135AllScoreDataWrapper.ReadObject(null, out var obj);
        ...
        {
            Th135AllScoreDataReadObjectHelper(new byte[0], out var obj);
        ...
        {
            var result = Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)SQOT.Null), out var obj);
        ...
        {
            var result = Th135AllScoreDataReadObjectHelper(TestUtils.MakeSQByteArray(value).ToArray(), out var obj);
        ...
        {
            Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)SQOT.Integer, new byte[3]), out var obj);
        ...
        {
            Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)SQOT.Float, new byte[3]), out var obj);
        ...
        {
            Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)SQOT.Bool), out var obj);
        ...
        public void Th135AllScoreDataReadObjectTestOTTable(int[] array, int[] expectedKeys, int[] expectedValues)
            => TestUtils.Wrap(() =>
            {
                var result = Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray(array), out var obj);
        ...
        {
            Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray(array), out var obj);
        ...
        {
            var result = Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)SQOT.Instance), out var obj);
        ...
        [DataRow((SQOT)999)]
        [ExpectedException(typeof(InvalidDataException))]
        public void Th135AllScoreDataReadObjectTestUnsupported(SQOT type) => TestUtils.Wrap(() =>
        {
            Th135AllScoreDataReadObjectHelper(TestUtils.MakeByteArray((int)type), out var obj);
