...
namespace ThScoreFileConverterTests.Models
{
    ...
    internal sealed class Th06ClearDataWrapper
    {
        ...
        public Th06ClearDataWrapper(Th06ChapterWrapper<Th06Converter> chapter)
            => this.pobj = new PrivateObject(AssemblyNameToTest, TypeNameToTest, new object[] { chapter?.Target });
        public Th06ClearDataWrapper(object obj)
        ...
        public IReadOnlyDictionary<ThConverter.Level, byte> StoryFlags
            => this.pobj.GetProperty(nameof(StoryFlags)) as Dictionary<ThConverter.Level, byte>;
        public IReadOnlyDictionary<ThConverter.Level, byte> PracticeFlags
            => this.pobj.GetProperty(nameof(PracticeFlags)) as Dictionary<ThConverter.Level, byte>;
