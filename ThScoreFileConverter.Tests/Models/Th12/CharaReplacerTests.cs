...
public class CharaReplacerTests
{
    ...
    public void ReplaceTestTotalPlayCount()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARARB1").ShouldBe("invoked: 23");
    }
    ...
    public void ReplaceTestPlayTime()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARARB2").ShouldBe("21:08:51");
    }
    ...
    public void ReplaceTestClearCount()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARARB3").ShouldBe("invoked: 490");
    }
    ...
    public void ReplaceTestCharaTotalTotalPlayCount()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARATL1").ShouldBe("invoked: 35");
    }
    ...
    public void ReplaceTestCharaTotalPlayTime()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARATL2").ShouldBe("37:09:04");
    }
    ...
    public void ReplaceTestCharaTotalClearCount()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARATL3").ShouldBe("invoked: 730");
    }
    ...
    public void ReplaceTestEmpty()
    {
        ...
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(dictionary, formatterMock);
        replacer.Replace("%T12CHARARB1").ShouldBe("invoked: 0");
        replacer.Replace("%T12CHARARB2").ShouldBe("0:00:00");
        replacer.Replace("%T12CHARARB3").ShouldBe("invoked: 0");
    }
    ...
    public void ReplaceTestInvalidFormat()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12XXXXXRB1").ShouldBe("%T12XXXXXRB1");
    }
    ...
    public void ReplaceTestInvalidChara()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARAXX1").ShouldBe("%T12CHARAXX1");
    }
    ...
    public void ReplaceTestInvalidType()
    {
        var formatterMock = NumberFormatterTests.Mock;
        var replacer = new CharaReplacer(ClearDataDictionary, formatterMock);
        replacer.Replace("%T12CHARARBX").ShouldBe("%T12CHARARBX");
    }
}
