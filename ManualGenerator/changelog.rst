...
v2.0.0 (2017/mm/dd)
    * :abbr:`MVVM (Model-View-ViewModel)`
      (`Wikipedia <https://ja.wikipedia.org/wiki/Model_View_ViewModel>`_)
      に則ってソフトウェアの構成を変更
    * ウィンドウなどのサイズをフォント設定に追従するように変更
    * マニュアルの作成に `Sphinx <http://www.sphinx-doc.org/ja/stable/>`_
      を利用するように変更
    * **FIXME:** `Semantic Versioning 2.0.0 <http://semver.org/>`_
      を参考にバージョン付与規則を変更
    * **FIXME:** 東方深秘録に対応
    * **FIXME:** 東方紺珠伝に対応
    * **FIXME:** ...

v1.10.0.0 (2014/10/05)
    * 東方心綺楼に対応
