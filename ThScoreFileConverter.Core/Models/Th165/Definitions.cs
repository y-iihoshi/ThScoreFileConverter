...
public static class Definitions
{
    ...
    public static IReadOnlyDictionary<(Day Day, int Scene), (Enemy[] Enemies, string Card)> SpellCards { get; } =
        new Dictionary<(Day, int), (Enemy[], string)>
        {
            ...
            { (Day.Friday,             1), (new[] { Enemy.Aun },        string.Empty) },
            { (Day.Friday,             2), (new[] { Enemy.Aun },        "独楽「コマ犬大回転」") },
            { (Day.Friday,             3), (new[] { Enemy.Aun },        "独楽「阿吽の閃光」") },
            ...
            { (Day.WrongSunday,        7), (new[] { Enemy.Aun },        "夢犬「１０１匹の野良犬」") },
