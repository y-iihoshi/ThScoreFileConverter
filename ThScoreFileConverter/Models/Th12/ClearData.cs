...
{
    internal class ClearData : Th10.ClearDataBase<CharaWithTotal, Th10.StageProgress, ScoreData>    // per character
    {
        ...
        {
            return Th10.ClearDataBase<CharaWithTotal, Th10.StageProgress, ScoreData>.CanInitialize(chapter)
