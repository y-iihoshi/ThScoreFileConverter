...
{
    internal class ClearData : Th10.ClearDataBase<CharaWithTotal, Th10.StageProgress, Th11.ScoreData>   // per character
    {
        ...
        {
            return Th10.ClearDataBase<CharaWithTotal, Th10.StageProgress, Th11.ScoreData>.CanInitialize(chapter)
