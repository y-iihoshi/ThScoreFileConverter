...
internal class ClearReplacer : Th13.ClearReplacerBase<
    Chara, CharaWithTotal, Level, Level, Core.Models.Th14.LevelPracticeWithTotal, Th14.StagePractice, IScoreData>
{
    public ClearReplacer(IReadOnlyDictionary<CharaWithTotal, Th13.IClearData<
        CharaWithTotal, Level, Level, Core.Models.Th14.LevelPracticeWithTotal, Th14.StagePractice, IScoreData>> clearDataDictionary)
